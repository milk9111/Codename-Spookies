...
Player.prototype.update = function() {
  ...
  if (this.walkingRight) {
    ...
    //Only move right if not off screen
    if (!this.offRight) {
  ...
  if (this.walkingLeft) {
    ...
    //Only move left if they are not going off screen
    if (!this.offLeft) {
  ...
  if (this.walkingForward) {
    ...
    //Only move the player if they are not off screen
    if (!this.offTop) {
  ...
  if (this.walkingBackward) {
    ...
    //only move down if they are not off screen
    if (!this.offBottom) {
