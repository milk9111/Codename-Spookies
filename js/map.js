  ...
  */
  static getTestMapO() {
    ...
    let test =
      ...
      "3QQRRRUTQRUTQQUTTQSUTQRQRQRQSRFJJLMNILMLMIJIJLIJLMNLIJLMLMLKIJLMLIJJLI3\n" +
      "3RQQURSQTQRSQUQRQRQQRURQRQRQSREJKINKIJMJKNIJKIOPJKJINKJIJKIJKJINKJJOPJ3\n" +
  ...
  static getMap2O() {
    ...
    "sBZBAADCBAaCBABDsABDCBABCBDBCABBDCBABDBCABDACBABDCsADBCBADC" + pd + "ADBDBCsBABACBABADBCDBADBCAaADCBADBADBCDBsBDCzDACDABsaDBCDBACDBAsADBCABlBsBDBCABDCBADCssssssssssssssssssss\n" +
    ...
    "sCAaAC" + pd2 + "BDACBDADCBDCB" + sc + "ACBADCBACDBADBCA" + pd1 + "dACBDABCADCBADCBACDBADCBACDBADCBADCBACADBBCDABCDABDCABDCABDCBADlBADCBABADABBADCBA" + sc + "CDDBADsBADCBADCBADCBADCBADCBADCABCDBADaBA" + ex1 + "CBDCs\n" +
