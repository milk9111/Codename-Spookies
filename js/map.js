  ...
  */
  static getTestMapO() {
    ...
    let test =
      ...
      "3RQbRQQRSRRRRQQQRQRQQRQQRQRQQQENOILMLNJKKklLMNLI&LMLMLKIJOPMLIJJL" + ex + "OJKI3\n" +
      ...
      "3QRQQQRQQRQ&TQRQUTdUR" + pd1 + "TQQRQQQRFIOPJNMJIOPKJIJNMJIOPJINMJINMOPJIPKIJPIJ3\n" +
      ...
      "3RQQURSQTQRSQUQRQRQRURSQRQTQSRFIOOJNMJIOPKJIJNMJI&PJINMJINMOPJJPKIJPIJ3\n" +
      "3RQQQQQRSQRRRQQQRQQQRQQRQRQQQRGIJLMNOPIJIOPIJNMOPPJNMOIJNNOPMNIOPIJINM3\n" +
      "33333333333333333333333333333333333333333333333333333333333333333333333\n";
  ...
  static getMap2O() {
    ...
    "sDCDAsDBDCAABCDABCDABCDABCsABCDBADBsADBACBDABCADCBsDCBACDBAzCBACDBADCBADCBACADBBCDABCDABDCABDCABDCBAsCBADCBABADABABDsCDBXCDBABADBCABCBABDBCABDCBA&CBADBCABDCABDCBADCs\n" +
    "sBDDAsDDAsssssssssssssDBADsCCDACDACsABCDAACDmBCDABsDABC*ABCDABCDABCDABCDABCDA" + pd2 + "CDABCDABCDABCDABCDABCDsBCDABCDAsssssssssssssssBADBCABCBDBACBDBACBDABDCBAdDBABzBCABABDDs\n" +
    ...
    "ssssssCCAstxysuxxBDACBA*CBDBAABBADBCADBACBDABCADCBsDCBACDBADCBACDBsDCBADCBA" + pd + "ADBBCDABCDABDCABDCABDCBAsCBADCBAABCsABCDABCDABCsABABDABCsDABDABABDCBADBACDBABDCcABDCABABs\n" +
    "sDABADABCDABCDABsABDCAssssssssssssssABCDABCDABCDABsDABCDABCDABCDABsDABCAABCDABCDABCDABCDABCDABCDABCDsBCDABCDDABsDABCDABCDABsDABCDABCsA*CDABCDABCDABCDABCDABCDABCDABCs\n" +
    ...
    "sCAaA" + pd2 + "CABDACBDADCBDCB" + sc + "ACBADCBACDBADBCA" + pd1 + "dACBDABCADCBADCBA*DBADCBACDBADCBADCBA&ADBBCDABCDABDCABDCABDCBADlBADCBABADABBADCBA" + sc + "CDDBADsBADCBADCBADCBADCBADCBADCABCDBADaBA" + ex1 + "CBDCs\n" +
  ...
  static getMap3O() {
    ...
    "!5645654k4564564564564564!no%qno%qno@656564564565567856756745m67564567585677645675646445658&Z45l745!!!!!               !456785678!!!!!!!!!!!!!!!!!!!!!!!!!!!!8457456845!!!!!!!!!!!5$6!!!!!!!!!!!!!!!\n" +
  ...
  static getBossMap() {
    ...
    "                           3^&**&^&*=======&2\n" +
    "                           2^&*=^&*&^*&^*===2\n" +
    "0123012301230123012301230301*&^=*&^=^&*=^*=^0\n" +
    "2^&*=^&*=^&*=^&*=^&*=^&*=^&*=^&*=^&*=^&*=&*=1\n" +
    "1^&*^&*^*&&*^*&^&*^===^&*^*&*&^*&=^&*==^&*=&2\n" +
    "3^&*=^&*=^&*=^&*=^&*=^&*=^&*=^&*=^&*=^&*=&*=3\n" +
    "2^&*=^&*=^&*=^&*=^&*=^&*=^&*=^&*=^&*=^&*=&*=2\n" +
    "1^&*=^&*=^&*=^&*=^&*=^&*=^&*=^&*=^&*=^&*=&*=1\n" +
    "012301230123030123023021302023012301230123010\n";
